...
//    MSC_BOT_Data[11] = (uint8_t)(blk_size);
  MSC_BOT_Data[3] = 0x08;
	MSC_BOT_Data[4] = (uint8_t)(blk_nbr >> 24);
  MSC_BOT_Data[5] = (uint8_t)(blk_nbr >> 16);
  MSC_BOT_Data[6] = (uint8_t)(blk_nbr >>  8);
  MSC_BOT_Data[7] = (uint8_t)(blk_nbr);
