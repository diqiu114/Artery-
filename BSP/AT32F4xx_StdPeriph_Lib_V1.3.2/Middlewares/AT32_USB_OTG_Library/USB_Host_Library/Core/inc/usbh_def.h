...
/* Use the following values when calling the function USB_HOST_GetDescriptor  */
...
#define  USB_EPT_TYPE_CTRL                               0x00
#define  USB_EPT_TYPE_ISOC                               0x01
#define  USB_EPT_TYPE_BULK                               0x02
#define  USB_EPT_TYPE_INTR                               0x03

#define  USB_EPT_DIR_OUT                                 0x00
#define  USB_EPT_DIR_IN                                  0x80
#define  USB_EPT_DIR_MSK                                 0x80  
...
typedef  struct  _DescriptorHeader 
{
    uint8_t  bLength;       
    uint8_t  bDescriptorType;
} 
USBH_DescriptorHeader;
...
typedef struct _HIDDescriptor
{
  ...
  uint8_t   bCountryCode;        /* specifies the transfer ept_type. */
  uint8_t   bNumDescriptors;     /* specifies the transfer ept_type. */
...
typedef struct _EndpointDescriptor
{
  ...
  uint8_t   bmAttributes;       /* specifies the transfer ept_type. */
