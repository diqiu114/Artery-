...
#define EPT_SPEED_LOW                           0
#define EPT_SPEED_FULL                          1
#define EPT_SPEED_HIGH                          2

#define EPT_TYPE_CTRL                           0
#define EPT_TYPE_ISOC                           1
#define EPT_TYPE_BULK                           2
#define EPT_TYPE_INTR                           3
#define EPT_TYPE_MSK                            3
...
/** @defgroup Internal_Macro's
  * @{
  */
#define USB_OTG_READ_R32(reg)  (*(__IO uint32_t *)(reg))
#define USB_OTG_WRITE_R32(reg,value) (*(__IO uint32_t *)(reg) = (value))
#define USB_OTG_MODIFY_R32(reg,clear_mask,set_mask) \
  USB_OTG_WRITE_R32((reg), (((USB_OTG_READ_R32(reg)) & ~(clear_mask)) | (set_mask)) )

/********************************************************************************
                              ENUMERATION TYPE
********************************************************************************/
enum USB_OTG_SPEED_MODE {
  USB_SPEED_UNKNOWN = 0,
  USB_SPEED_LOW,
  USB_SPEED_FULL,
  USB_SPEED_HIGH
