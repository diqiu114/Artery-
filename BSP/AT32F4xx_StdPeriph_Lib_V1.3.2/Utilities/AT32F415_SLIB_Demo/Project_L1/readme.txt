...
@par Example Description 
   ...
   - Symbol definition file (fir_filter_symbol.txt for MDK-ARM) containing the protected function symbols 
	 ...
	 - The assembly code "slib_used_c_lib.s" includes the binary file of the used ARM software floating-point library. In Project_L1,
	   this file must be placed to the fixed address 0x0803D000.    
...
Related IP-Code files provided from Project_L0:
  ...
  - Project_L1/MDK_V5/slib_used_c_lib.s                  Assembly code conatining the used ARM software floating-point library    
