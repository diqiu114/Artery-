...
//#define USE_SLIB_FUNCTION       /* Define it when user want to activate SLIB in this project */
 ...
 #if defined (AT32F413Kx_HD) || defined (AT32F413Cx_HD) || defined (AT32F413Rx_HD)
   #define  FLASH_PAGE_SIZE  2048
 #endif

 #if defined (AT32F413Kx_MD) || defined (AT32F413Cx_MD) || defined (AT32F413Rx_MD)
