...
int main(void)
{
  /*!< At this stage the microcontroller clock setting is already configured,
       ...
       file (startup_at32f407_xx.s) before to branch to application main.
  ...
  /* -----------------------------------------------------------------------
    ...
    The TMR10CLK frequency is set to SystemCoreClock (240 MHz), to get TMR10 counter
...
void GPIO_Configuration(void)
{
  ...
  /* Enable TMR10 and GPIOF clock */
  RCC_APB2PeriphClockCmd(RCC_APB2PERIPH_TMR10 | RCC_APB2PERIPH_GPIOB, ENABLE);

  /* GPIOF Configuration: TMR10 Channel1 as alternate function push-pull */
