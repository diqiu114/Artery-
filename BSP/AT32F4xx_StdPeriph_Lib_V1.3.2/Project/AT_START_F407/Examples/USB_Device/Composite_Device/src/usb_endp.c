/**
  ******************************************************************************
  * File   : USB_Device/Composite_Device/src/usb_endp.c
  * Version: V1.3.2
  * Date   : 2021-08-08
...
void EP1_IN_Callback(void)
{
  uint16_t dwSendLen = 0;
	...
	if ( dwSendLen > Composite_DATA_SIZE )
	{
		dwSendLen = Composite_DATA_SIZE;
	}
...
void EP3_OUT_Callback(void)
{
  ...
  if ( (((usb_rxfifo.wrpointer - usb_rxfifo.curpointer) > (USB_FIFO_MAX - Composite_DATA_SIZE)) && (usb_rxfifo.wrpointer > usb_rxfifo.curpointer ))
	  || ((usb_rxfifo.curpointer - usb_rxfifo.wrpointer < Composite_DATA_SIZE) && usb_rxfifo.curpointer > usb_rxfifo.wrpointer))
  {
