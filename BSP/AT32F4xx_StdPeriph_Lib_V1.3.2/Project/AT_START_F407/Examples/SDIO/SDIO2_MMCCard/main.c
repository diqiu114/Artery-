...
#define STREAM_BUFFER_SIZE (4096) ///< MMC Card Stream Test Buffer Size

/* Private variables ---------------------------------------------------------*/
static __IO uint32_t TimingDelay; ///< TimeBase for 1 ms
...
static TEST_RESULT SD_SingleBlockTest(void)
{
  ...
  /* Test 1-bit, 4-bit and 8-bit width */
  for(bus_width = 0; bus_width < 3; bus_width++)
  {
...
static void NVIC_Configuration(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannel = SDIO2_IRQn;
