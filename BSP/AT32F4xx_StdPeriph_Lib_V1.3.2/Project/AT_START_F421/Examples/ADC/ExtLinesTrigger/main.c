...
__IO uint16_t ADC_RegularConvertedValueTab[16], ADC_InjectedConvertedValueTab[16];
...
int main(void)
{
	...
	ADC_InitStructure.ADC_ExternalTrig      = ADC_ExternalTrig_Ext_INT11_TMR8_TRGO_ADC12 ; //ADC_ExternalTrig_None  ADC_ExternalTrig_Ext_INT11_TMR8_TRGO_ADC12
...
void EXTI_Configuration(void)
{
	...
	SYSCFG_EXTILineConfig(GPIO_PortSourceGPIOA, GPIO_PinsSource11);
    ...
    SYSCFG_EXTILineConfig(GPIO_PortSourceGPIOA, GPIO_PinsSource15);
