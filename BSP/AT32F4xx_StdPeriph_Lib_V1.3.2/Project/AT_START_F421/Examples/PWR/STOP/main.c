...
static void ERTC_Alarm_ValueSet(uint32_t alam_index);
...
static void ERTC_Config(void)
{
  ...
  ERTC_SetTimeValue(ERTC_Format_BIN, &ERTC_TimeStruct);
}
...
static void ERTC_AlarmConfig(void)
{
  ...
  ERTC_AlarmStructure.ERTC_AlarmMask = ERTC_AlarmMask_DateWeek | ERTC_AlarmMask_Hours | ERTC_AlarmMask_Minutes;
  ...
  ERTC_AlarmStructure.ERTC_AlarmTime.ERTC_Seconds =0x3;
...
/**
  * @brief  Set the ERTC Alarm value.
...
static void ERTC_Alarm_ValueSet(uint32_t alam_index)
{
  ...
  ERTC_AlarmStructure.ERTC_AlarmTime.ERTC_Seconds =(ERTC_TimeStruct.ERTC_Seconds + alam_index) % 60;
  ERTC_SetAlarmValue(ERTC_Format_BIN, ERTC_AlA, &ERTC_AlarmStructure);
