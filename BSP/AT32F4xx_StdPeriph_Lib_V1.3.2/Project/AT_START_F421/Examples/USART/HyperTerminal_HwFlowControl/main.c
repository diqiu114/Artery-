...
void GPIO_Configuration(void)
{
  ...
  /* Connect PXx to USART2_CTS */
  GPIO_PinAFConfig(GPIOA, GPIO_PinsSource0, GPIO_AF_1);
  
  /* Connect PXx to USART2_RTS */
  GPIO_PinAFConfig(GPIOA, GPIO_PinsSource1, GPIO_AF_1);

  /* Configure USART2 TX, USART2 RX, USART2 CTS and USART2 RTS as alternate function push-pull */
