...
int main(void)
{
  ...
  /* DMA1 Channel2 transfer complete test */
...
void GPIO_Configuration(void)
{
  ...
  GPIO_PinAFConfig(GPIOA, GPIO_PinsSource1, GPIO_AF_4); 
  GPIO_PinAFConfig(GPIOA, GPIO_PinsSource9, GPIO_AF_4); 
  GPIO_PinAFConfig(GPIOA, GPIO_PinsSource10, GPIO_AF_4); 
  
  GPIO_InitStructure.GPIO_Pins = GPIO_Pins_0|GPIO_Pins_1|GPIO_Pins_9|GPIO_Pins_10;
