/**
  ******************************************************************************
  * File   : I2C/Poll(10bit_addr)_MA_RX&SLA_TX/at32f4xx_i2c_ex.c 
  * Version: V1.3.2
  * Date   : 2021-08-08
...
/** @addtogroup Polling(10bit_address) - Master Receiver & Slave Transmitter
...
I2C_StatusType I2C_Master_Receive(I2C_Type* I2Cx, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  /* Send slave address header read */
  I2C_SendData(I2Cx, I2C_10BIT_HEADER_READ(DevAddress));
