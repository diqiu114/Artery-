...
void  AT32_I2C_Init(I2C_Type *I2Cy)
{
  ...
  if(I2Cy == I2C1)
  {
    ...
    I2C_TX_DMA1_Channelx = DMA1_Channel2;
    I2C_RX_DMA1_Channelx = DMA1_Channel3;
    I2C_TX_DMA1_Channelx_IRQn = DMA1_Channel3_2_IRQn;
    I2C_RX_DMA1_Channelx_IRQn = DMA1_Channel3_2_IRQn;
  ...
  else
  {
    ...
    GPIO_InitStructure.GPIO_Pins     = GPIO_Pins_11 | GPIO_Pins_12;    //SCL | SDA
    GPIO_InitStructure.GPIO_Mode     = GPIO_Mode_AF;
    GPIO_InitStructure.GPIO_OutType  = GPIO_OutType_OD;
    GPIO_InitStructure.GPIO_Pull     = GPIO_Pull_NOPULL;  
    GPIO_Init(GPIOA, &GPIO_InitStructure);
      
    GPIO_PinAFConfig(GPIOA, GPIO_PinsSource11, GPIO_AF_5);
    
    GPIO_PinAFConfig(GPIOA, GPIO_PinsSource12, GPIO_AF_5);   
    
    I2C_TX_DMA1_Channelx = DMA1_Channel4;
    I2C_RX_DMA1_Channelx = DMA1_Channel5;
    I2C_TX_DMA1_Channelx_IRQn = DMA1_Channel7_4_IRQn;
    I2C_RX_DMA1_Channelx_IRQn = DMA1_Channel7_4_IRQn;
