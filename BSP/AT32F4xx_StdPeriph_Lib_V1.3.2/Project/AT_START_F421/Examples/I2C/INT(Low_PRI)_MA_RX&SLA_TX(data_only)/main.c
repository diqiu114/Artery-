/**
  ******************************************************************************
  * File   : I2C/INT(Low_PRI)_MA_RX&SLA_TX(data_only)/main.c 
  * Version: V1.3.2
  * Date   : 2021-08-08
...
/** @addtogroup INT(Low_PRI)_MA_RX&SLA_TX(data_only)
  * @{
  */ 
...
int main(void)
{
  ...
  printf("Interrupt(Low priority) - Master Receiver & Slave Transmitter(data only).\r\n");
