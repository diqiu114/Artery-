/**
  ******************************************************************************
  * File   : I2C/Poll(10bit_addr)_MA_TX&SLA_RX/main.c 
  * Version: V1.3.2
  * Date   : 2021-08-08
...
/** @addtogroup Poll(10bit_addr)_MA_TX&SLA_RX
  * @{
  */ 
...
int main(void)
{
  ...
  printf("Polling(10bit_address) - Master Transmitter & Slave Receiver.\r\n");			
  ...
  while(1)
  {
    ...
    if((I2C_Status = I2C_Master_Transmit(I2C_PORT, I2C_SLAVE_ADDRESS10, tx_buf, BUF_SIZE, 10000)) != I2C_OK)
    {
