...
#define SPI_MASTER_GPIO_CLK          RCC_AHBPERIPH_GPIOA  
...
/* Enable peripheral clocks --------------------------------------------------*/
  ...
  RCC_AHBPeriphClockCmd(SPI_MASTER_GPIO_CLK | SPI_SLAVE_GPIO_CLK | RCC_AHBPERIPH_GPIOF, ENABLE);
...
void GPIO_Configuration()
{
  ...
  GPIO_PinAFConfig(SPI_MASTER_GPIO, GPIO_PinsSource7, GPIO_AF_0);

  /* Configure SPI_SLAVE pins: SCK and MISO*/
  GPIO_InitStructure.GPIO_Pins =  SPI_SLAVE_PIN_MOSI;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;
  GPIO_InitStructure.GPIO_Pull = GPIO_Pull_PD;
  ...
  GPIO_PinAFConfig(SPI_SLAVE_GPIO, GPIO_PinsSource15, GPIO_AF_0);
