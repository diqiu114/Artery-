...
void RCC_Configuration(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2PERIPH_ADC1 | RCC_APB2PERIPH_TMR1 | RCC_APB2PERIPH_GPIOC | RCC_APB2PERIPH_GPIOA, ENABLE);
}
...
void GPIO_Configuration(void)
{
	...
	/* Configure TMR pin as alternate function push-pull */
