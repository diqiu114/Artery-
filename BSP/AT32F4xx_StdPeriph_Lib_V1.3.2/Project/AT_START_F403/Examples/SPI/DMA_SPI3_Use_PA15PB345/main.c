/**
  ******************************************************************************
  * File   : SPI/SPI_DMA_SPI3_Use_PA15PB345/main.c 
  * Version: V1.3.2
  * Date   : 2021-08-08
...
/** @addtogroup SPI_DMA_SPI3_Use_PA15PB345
  * @{
  */ 
...
#define SPI_MASTER_GPIO_CLK_NSS      RCC_APB2PERIPH_GPIOA 
...
void RCC_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(SPI_MASTER_GPIO_CLK | SPI_MASTER_GPIO_CLK_NSS | SPI_SLAVE_GPIO_CLK |
                          RCC_APB2PERIPH_GPIOD | RCC_APB2PERIPH_AFIO, ENABLE);

  /* Enable SPI_MASTER clock and SPI_SLAVE Periph clock */
  RCC_APB1PeriphClockCmd(SPI_MASTER_CLK | SPI_SLAVE_CLK, ENABLE);
...
void GPIO_Configuration(void)
{
  ...
  GPIO_InitStructure.GPIO_Pins = SPI_SLAVE_PIN_NSS | SPI_SLAVE_PIN_SCK;
