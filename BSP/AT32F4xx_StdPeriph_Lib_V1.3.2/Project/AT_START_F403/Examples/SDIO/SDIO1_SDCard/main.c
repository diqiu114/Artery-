/**
  ******************************************************************************
  * File   : SDIO/SDIO1_SDCard/main.c
  * Version: V1.3.2
  * Date   : 2021-08-08
  * Brief  : SD card function test.
  ******************************************************************************
  */
...
#define BLOCKS_NUMBER        (64)  ///< Multiple Blocks Test Numbers
...
static void NVIC_Configuration(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannel = SDIO1_IRQn;
...
int main(void)
{
  ...
  {
    printf("SD Card Single Block Test Failed.\r\n");
  ...
  printf("SD Card Single Block Test Pass.\r\n");

  /* --------SD Card Multiple Blocks Test -----------------------------*/
  if(SD_MultipleBlocksTest() != TEST_SUCCESS)
  {
    printf("SD Card Multiple Blocks Test Failed.\r\n");
  ...
  printf("SD Card Multiple Blocks Test Pass.\r\n");
