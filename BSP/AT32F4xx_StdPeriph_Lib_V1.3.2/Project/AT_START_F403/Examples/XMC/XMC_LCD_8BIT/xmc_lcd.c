...
void XMC_init(void)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2PERIPH_GPIOB|RCC_APB2PERIPH_GPIOD | RCC_APB2PERIPH_GPIOG | RCC_APB2PERIPH_GPIOE |
  ...
  GPIO_InitStructure.GPIO_Pins = GPIO_Pins_0 | GPIO_Pins_1 | GPIO_Pins_14 | GPIO_Pins_15;
  ...
  //XMC_NORSRAMStructInit(&XMC_NORSRAMInitStruct);
