/**
  ******************************************************************************
  * File   : USB_Device/USB_Printer/src/hw_config.c
  * Version: V1.3.2
  * Date   : 2021-08-08
...
void Get_SerialNum(void)
{
  ...
  if (Device_Serial0 != 0)
  {
    IntToUnicode (Device_Serial0, &USB_Printer_StringSerial[2] , 8);
    IntToUnicode (Device_Serial1, &USB_Printer_StringSerial[18], 4);
  }
}
