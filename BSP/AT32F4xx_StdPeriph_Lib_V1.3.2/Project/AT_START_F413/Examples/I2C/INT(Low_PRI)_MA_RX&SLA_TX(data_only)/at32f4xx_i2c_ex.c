/**
  ******************************************************************************
  * File   : I2C/INT(Low_PRI)_MA_RX&SLA_TX(data_only)/at32f4xx_i2c_ex.c 
  * Version: V1.3.2
  * Date   : 2021-08-08
...
/** @addtogroup Interrupt(Highest_priority) - Master Receiver & Slave Transmitter(data only)
...
/**
  * @brief  ms delay used by the I2C.
  * @param  us: delay x us.
  * @retval None
  */
...
/**
  ...
  * @retval I2C status.
  */
I2C_StatusType I2C_Master_Receive_INT(I2C_Type* I2Cx, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
...
/**
  ...
  * @retval I2C status
  */
I2C_StatusType I2C_Slave_Transmit_INT(I2C_Type* I2Cx, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
...
{
  /*I2C in mode Master Receiver */
  
  if(I2C_GetFlagStatus(I2Cx, I2C_FLAG_BTFF) == SET)
  {
    if(RxCount == 3)
    {
      /* Disable ack */
  ...
  else if(I2C_GetFlagStatus(I2Cx, I2C_FLAG_RDNE) == SET)
  {
    ...
    else if((RxCount == 3) || (RxCount == 2))
    {
      /* Disable RDNE */
      I2C_INTConfig(I2Cx, I2C_INT_BUF, DISABLE);
    }
    else
    {
      /* Read data from DR */
