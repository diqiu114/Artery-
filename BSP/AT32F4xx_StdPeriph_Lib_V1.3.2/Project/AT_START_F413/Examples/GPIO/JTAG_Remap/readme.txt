/**
  ...
  * BUTTON_WAKEUP(PA0) is pressed the SWJ-DP will be disabled. The SWJ-DP pins are configured
  * as output push-pull. The PA.13(JTMS/SWDAT), PA.14(JTCK/SWCLK), PA.15(JTDI),
