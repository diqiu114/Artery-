...
{          
   ...
   *  The TIMxCLK is fixed to 192 MHz, the TMR2 counter clock is 192 MHz.

      The Master Timer TMR2 is running at TMR2 frequency :
      TIM2 frequency = (TMR2 counter clock)/ (TMR2 period + 1) = 281.250 KHz 
      and the duty cycle = TMR2_CCR1/(TMR2_ARR + 1) = 25%.

      The TMR3 is running at:
      (TMR2 frequency)/ (TMR3 period + 1) = 70.312 KHz and a duty cycle equal 
      to TMR3_CCR1/(TMR3_ARR + 1) = 25%

      The TMR4 is running at:
      (TMR3 frequency)/ (TMR4 period + 1) = 17.578 Hz and a duty cycle equal 
