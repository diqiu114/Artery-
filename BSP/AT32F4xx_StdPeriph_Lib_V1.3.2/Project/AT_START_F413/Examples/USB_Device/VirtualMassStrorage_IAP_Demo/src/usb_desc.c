/**
  ******************************************************************************
  * File   : USB_Device/VirtualMassStorage_IAP_Demo/src/hw_config.c
  * Version: V1.3.2
  * Date   : 2021-08-08
  * Brief  : Description for Mass Storage Demo
  ******************************************************************************
  */
...
const uint8_t MASS_StringVendor[MASS_SIZ_STRING_VENDOR] =
  {
    ...
    'A', 0, 'r', 0, 't', 0, 'e', 0, 'r', 0, 'y', 0, ' ', 0, 'T', 0,
    'e', 0, 'c', 0, 'h', 0, 'n', 0, 'o', 0, 'l', 0, 'o', 0, 'g', 0,
    'y', 0, 
  };
...
const uint8_t MASS_StringProduct[MASS_SIZ_STRING_PRODUCT] =
  {
    ...
    0x03,
    /* Product name: "AT32 USB Mass Storage" */
    'A', 0, 'T', 0, '3', 0, '2', 0, ' ', 0, 'M', 0, 'a', 0, 's', 0,
