...
/* Define the AT32F403A hardware depending on the used AT board */
  ...
  #define SPI_MASTER_Rx_DMA_Channel    DMA1_Channel1
  #define SPI_MASTER_Rx_DMA_FLAG       DMA1_FLAG_TC1
  #define SPI_MASTER_Tx_DMA_Channel    DMA1_Channel2
  #define SPI_MASTER_Tx_DMA_FLAG       DMA1_FLAG_TC2  
  ...
  #define SPI_SLAVE_Rx_DMA_Channel     DMA1_Channel3
  #define SPI_SLAVE_Rx_DMA_FLAG        DMA1_FLAG_TC3
  #define SPI_SLAVE_Tx_DMA_Channel     DMA1_Channel4
  #define SPI_SLAVE_Tx_DMA_FLAG        DMA1_FLAG_TC4  
