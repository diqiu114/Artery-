/**
  ******************************************************************************
  * File   : USB_Device/VirtualMassStorage_IAP_Demo/src/usb_bot.c
  * Version: V1.3.2
  * Date   : 2021-08-08
...
/**
  ...
  * @param  CSW_Status: this filed can be CSW_CMD_PASSED,CSW_CMD_FAILED,
  *         or CSW_PHASE_ERROR..
  * @param  Send_Permission: permission
  * @retval None.
  */
