...
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define ERTC_BKP_DT_NUMBER              20  /* ERTC Backup Data Register Number */
...
uint32_t aERTC_BKP_DT[ERTC_BKP_DT_NUMBER] =
  {
    ERTC_BKP_DT0, ERTC_BKP_DT1, ERTC_BKP_DT2, ERTC_BKP_DT3, 
    ERTC_BKP_DT4, ERTC_BKP_DT5, ERTC_BKP_DT6, ERTC_BKP_DT7,
    ERTC_BKP_DT8, ERTC_BKP_DT9, ERTC_BKP_DT10, ERTC_BKP_DT11,
    ERTC_BKP_DT12, ERTC_BKP_DT13, ERTC_BKP_DT14, ERTC_BKP_DT15,
    ERTC_BKP_DT16, ERTC_BKP_DT17, ERTC_BKP_DT18, ERTC_BKP_DT19
  };
