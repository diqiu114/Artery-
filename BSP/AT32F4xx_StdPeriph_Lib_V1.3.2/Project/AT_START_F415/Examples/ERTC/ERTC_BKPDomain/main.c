...
/*#define ERTC_CLOCK_SOURCE_LSI */     /* LSI used as ERTC source clock */

#define ERTC_BKP_DR_NUMBER   0x14
...
uint32_t aBKPDataReg[ERTC_BKP_DR_NUMBER] =
  {
    ...
    ERTC_BKP_DT3, ERTC_BKP_DT4, ERTC_BKP_DT5,
    ERTC_BKP_DT6, ERTC_BKP_DT7, ERTC_BKP_DT8, 
    ERTC_BKP_DT9, ERTC_BKP_DT10, ERTC_BKP_DT11, 
    ERTC_BKP_DT12, ERTC_BKP_DT13, ERTC_BKP_DT14, 
    ERTC_BKP_DT15, ERTC_BKP_DT16, ERTC_BKP_DT17, 
    ERTC_BKP_DT18,  ERTC_BKP_DT19
  };
...
/* The ERTC Clock may varies due to LSI frequency dispersion. */
 ...
 /* ck_spre(1Hz) = ERTCCLK(LSE) /(uwAsynchPrediv + 1)*(uwSynchPrediv + 1)*/
  ...
  /* Configure the ERTC Wakeup Clock source and Counter (Wakeup event each 1 second) */
  ERTC_WakeUpClockConfig(ERTC_WakeUpClockSelect_RTCCLK_Div16);
  ERTC_SetWakeUpCounter(0x7FF);
  ERTC_ClearFlag(ERTC_FLAG_WATF);
