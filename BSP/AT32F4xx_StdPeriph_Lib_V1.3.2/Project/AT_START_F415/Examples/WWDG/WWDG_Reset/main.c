...
int main(void)
{
  ...
  /* On other devices, WWDG clock counter = (PCLK1(72MHz)/4096)/8 = 2197 Hz (~455 us)  */
  ...
  /* Enable WWDG and set counter value to 127, WWDG timeout = ~455 us * 64 = 29.12 ms
    In this case the refresh window is: 21.39 ms(~455 us * (127-80)) < refresh window < 29.12ms
  */
  WWDG_Enable(127);
