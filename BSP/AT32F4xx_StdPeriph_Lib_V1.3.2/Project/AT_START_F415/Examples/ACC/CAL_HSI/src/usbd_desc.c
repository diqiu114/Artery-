...
#define USB_DEVICE_PRODUCT_HS_STRING          "AT32 Virtual ComPort in HS mode"
#define USB_DEVICE_PRODUCT_FS_STRING          "AT32 Virtual ComPort in FS Mode"
#define USB_DEVICE_CONFIGURATION_HS_STRING    "VCP Config"
#define USB_DEVICE_INTERFACE_HS_STRING        "VCP Interface"
#define USB_DEVICE_CONFIGURATION_FS_STRING    "VCP Config"
#define USB_DEVICE_INTERFACE_FS_STRING        "VCP Interface"
/**
  * @}
  */ 
