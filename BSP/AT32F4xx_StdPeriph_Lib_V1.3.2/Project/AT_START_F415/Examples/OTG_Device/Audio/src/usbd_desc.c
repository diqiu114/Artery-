...
#define USB_DEVICE_PRODUCT_HS_STRING        "AT32 Audio"
#define USB_DEVICE_PRODUCT_FS_STRING        "AT32 Audio"
#define USB_DEVICE_CONFIGURATION_HS_STRING  "AUDIO Config"
#define USB_DEVICE_INTERFACE_HS_STRING      "AUDIO Interface"
#define USB_DEVICE_CONFIGURATION_FS_STRING  "AUDIO Config"
#define USB_DEVICE_INTERFACE_FS_STRING      "AUDIO Interface"
/**
  * @}
  */ 
