/**
  @page OTG USB Device Audio example
...
The AT32 USB_Device Audio Composite Speaker and Microphone gives example how
...
Hardware Board
******************
details of this board is given in the "AT_START_F415".
