...
int main(void)
{
  ...
  /* Gated mode test -----
    ...
    * The TIMxCLK is fixed to 144 MHZ, the Prescaler is equal to 2 so the TMRx clock 
      counter is equal to 48 MHz.
      The Three Timers are running at: 
      TMRx frequency = TMRx clock counter/ 2*(TIMx_Period + 1) = 303.03 KHz. 
  */
