/**
  ******************************************************************************
  * File   : I2C/INT(Highest_PRI)_MA_RX&SLA_TX/at32f4xx_i2c_ex.c 
  * Version: V1.3.2
  * Date   : 2021-08-08
  * Brief  : The driver of the I2C communication example based on interrupt mode.
  *          This example uses the highest priority interrupt.
  ******************************************************************************
  */
...
/** @addtogroup Interrupt(Highest_priority) - Master Receiver & Slave Transmitter
...
void I2C_EV_IRQHandler(I2C_Type* I2Cx)
{
  ...
  { 
    ...
    I2C_Send7bitAddress(I2Cx, Address, I2C_Direction_Receive);    
  }
...
void I2C_EV_IRQHandler(I2C_Type* I2Cx)
{
  ...
  /* Step 1: Successull received slave address */
