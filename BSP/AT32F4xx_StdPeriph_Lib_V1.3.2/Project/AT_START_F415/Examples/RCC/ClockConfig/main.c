...
{
  {24 , RCC_CFG_APB1PSC_DIV1, RCC_CFG_APB2PSC_DIV1, RCC_CFG_PLLMULT6 , FLASH_ACR_LATENCY_0},
  {36 , RCC_CFG_APB1PSC_DIV1, RCC_CFG_APB2PSC_DIV1, RCC_CFG_PLLMULT9 , FLASH_ACR_LATENCY_1},
  {48 , RCC_CFG_APB1PSC_DIV1, RCC_CFG_APB2PSC_DIV1, RCC_CFG_PLLMULT12, FLASH_ACR_LATENCY_1},
  {56 , RCC_CFG_APB1PSC_DIV1, RCC_CFG_APB2PSC_DIV1, RCC_CFG_PLLMULT14, FLASH_ACR_LATENCY_1},
  {72 , RCC_CFG_APB1PSC_DIV1, RCC_CFG_APB2PSC_DIV1, RCC_CFG_PLLMULT18, FLASH_ACR_LATENCY_2},
  {96 , RCC_CFG_APB1PSC_DIV2, RCC_CFG_APB2PSC_DIV2, RCC_CFG_PLLMULT24, FLASH_ACR_LATENCY_2},
  {108, RCC_CFG_APB1PSC_DIV2, RCC_CFG_APB2PSC_DIV2, RCC_CFG_PLLMULT27, FLASH_ACR_LATENCY_3},
  {120, RCC_CFG_APB1PSC_DIV2, RCC_CFG_APB2PSC_DIV2, RCC_CFG_PLLMULT30, FLASH_ACR_LATENCY_3},
  {144, RCC_CFG_APB1PSC_DIV2, RCC_CFG_APB2PSC_DIV2, RCC_CFG_PLLMULT36, FLASH_ACR_LATENCY_4},
};
...
ErrorStatus SysclkConfig(enum PLLClkSrc Src, uint32_t DestClkFreq)
{
  ...
  /* Set flash latency */
  FLASH->ACR &= ~0x7;
  FLASH->ACR |= ClockTable[index].Flash_latency;
